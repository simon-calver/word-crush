...
import { EmptyTile, LetterTile } from './letter-tile.js';
...
export default class MainScene extends Phaser.Scene {
  ...
  removeTiles(wordTiles) {
    ...
    // make array of zeros of width xSize
    let offset = Array(this.gridWidth).fill(0);
    ...
    for (let pos of wordTiles) {
      ...
      if (this.extraTiles > 0) {
        ...
        newTiles[pos[0]][0] = new LetterTile(this, this.startX + pos[0] * this.cellWidth, this.startY - 180 - offset[pos[0]] * this.cellWidth, this.tileWidth, ALPHABET[letterIndex], 0);
  ...
  updateTilePositions() {
    // stop them, being interactive!!
    // this.tiles.forEach((row, rowIndex) => row.forEach((tile, colIndex) => tile.setTilePosition(this.getWorldPos(rowIndex, colIndex))));
    // Do this better
